...
c  For descriptive comments, go back to int_chless1&2
        ...
        real r31,r32,r33,r34,r35,r36,r37,r38,r39,xnn,ynn,gnn,dyopiinv
...
25      CONTINUE
        ...
        IF(nns.GT.np_max) WRITE(*,*)'error in int_chless3',nns
        DO 251 n = nb1,nb2
...
C_____________________
     ...
     &              kfar,Listfar,kclose,Listclose)
        ...
        IF(nn.GT.np_max)WRITE(*,*)'error in int_chless3p',nn
        IF(kfp.GT.nbox_max)WRITE(*,*)'error in int_chless3b',kfp
