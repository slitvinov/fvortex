...
c  Same idea as in int_chless2 but now for level 4 childless boxes.
c  For descriptive comments, go back to int_chless1&2
        ...
        real r41,r42,r43,r44,r45,r46,r47,r48,r49,xnn,ynn,gnn,dyopiinv
...
c----------------------------------------------------------------------------
        ...
        DO 20 kh = 1,Kchildless4
          ...
          nb1 = NPB4(kb,1)
          nb2 = NPB4(kb,2)
          ipar = (XC4(kb)-X0)/ds3 + 1
          jpar = (YC4(kb)-Y0)/ds3 + 1
           kc = 0
...
25      CONTINUE
        ...
        IF(nns.GT.np_max) WRITE(*,*)'error in int_chless4',nns
        DO 251 n = nb1,nb2
...
C_____________________
     ...
     &              kfar,Listfar,kclose,Listclose)
        ...
        IF(nn.GT.np_max)WRITE(*,*)'error in int_chless4p',nn
        IF(kfp.GT.nbox_max)WRITE(*,*)'error in int_chless4b',kfp
