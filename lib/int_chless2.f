...
c  Same idea as in int_chless1 but now for level 2 childless boxes.
        ...
        real r21,r22,r23,r24,r25,r26,r27,r28,r29,xnn,ynn,gnn,dyopiinv
...
C the initial list to examine is now Listexam.
          CALL near_far(Nmax2,ib,jb,r22,IC2,JC2,kexam,Listexam,kfar
...
25      CONTINUE
        ...
        IF(nns.GT.np_max) WRITE(*,*)'error in int_chless2',nns
        DO 251 n = nb1,nb2
...
C_____________________
     ...
     &              kfar,Listfar,kclose,Listclose)
        ...
        IF(nn.GT.np_max)WRITE(*,*)'error in int_chless2p',nn
        IF(kfp.GT.nbox_max)WRITE(*,*)'error in int_chless2b',kfp
