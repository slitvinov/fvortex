/* ../box9_to_part.f -- translated by f2c (version 20160102).
...
/* Subroutine */ int box9_to_part__(integer *nmax, integer *kchildless, real *
	xc, real *yc, integer *npb, real *br, real *bi)
{
