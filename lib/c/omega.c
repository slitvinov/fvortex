/* ../omega.f -- translated by f2c (version 20160102).
...
/* --------------------------------------------------------- */
    if (motion_1.wfree == 1) {
	ret_val = motion_1.last_w__;
    } else {
	ret_val = motion_1.w_const__ + motion_1.w_amp__ * sin(
		motion_1.w_freq__ * *time + motion_1.w_phase__);
    }
    return ret_val;
} /* omega_ */
